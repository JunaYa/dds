...
export function PopoverPopup({
  ...
  return (
    <PopoverPrimitive.Portal container={container} {...portalProps}>
        ...
        >
          <PopoverPrimitive.Viewport
            className={cn(
              ...
              padding === 'sm'
                ? 'not-data-transitioning:overflow-y-auto py-2 [--viewport-inline-padding:--spacing(2)]'
                : tooltipStyle
                  ? 'py-1 [--viewport-inline-padding:--spacing(2)]'
                  : 'not-data-transitioning:overflow-y-auto py-4 [--viewport-inline-padding:--spacing(4)]'
            )}

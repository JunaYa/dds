  ...
  return (
    <SelectPrimitive.Portal {...portalProps}>
      <SelectPrimitive.Positioner
        ...
        anchor={anchor}
        // Sit above the modal layer so the popup stays visible when a Select
        // is opened from inside a Dialog (which renders a z-modal backdrop).
        className="z-[calc(var(--z-layer-modal)+1)] select-none"

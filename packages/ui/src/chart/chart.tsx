      ...
      <div className="grid gap-1.5">
        {payload.map((item: TooltipPayloadItem, index: number) => {
          ...
          return (
            <div
              className={cn(
                'flex w-full flex-wrap items-stretch gap-2 [&>svg]:h-2.5 [&>svg]:w-2.5 [&>svg]:text-foreground-muted-rest',
              ...
              {formatter && item?.value !== undefined && item.name ? (
                ...
                <>
                  ...
                  >
                    <div className="grid gap-1.5">
                      {nestLabel ? tooltipLabel : null}
                      <span className="text-foreground-muted-rest">
    ...
    >
      {payload.map((item: LegendPayloadItem) => {
        ...
        return (
          <div
            className={cn(
              'flex items-center gap-1.5 [&>svg]:h-3 [&>svg]:w-3 [&>svg]:text-foreground-muted-rest'
            )}
            key={item.value}
          >
